"""
Django settings for simple_ig project.
...
SECRET_KEY = 'django-insecure-q%%-!n*9@sz9)_q)jgptnb2d^3s(hmzivc29#cvq)$br19ce#0'
...
WSGI_APPLICATION = 'simple_ig.wsgi.application'
